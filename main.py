...
def Spinner():
	l = ['|', '/', '-', '\\']
	for i in l+l+l:
		sys.stdout.write('\r' + Fore.GREEN +'YTZ TokenGen is Starting...'+i)
		sys.stdout.flush()
		time.sleep(0.2)
...
print(Fore.WHITE +Fore.RED +"-\Welcome to "+Fore.BLUE+" YTZ TokenGen -\-\-")
...
if opcion=='1':
	...
	while int(count)<int(cantidad):
		...
		if int(count)==int(cantidad):
			...
			os.system("cls")
			print(Fore.WHITE +Fore.RED +"                         ["+Fore.WHITE +Fore.RED +"+"+Fore.WHITE +Fore.RED +"]"+ Fore.WHITE +Fore.RED +"-------------------------------------------------------"+ Fore.WHITE +Fore.RED +"["+ Fore.WHITE +Fore.RED +"+"+ Fore.WHITE +Fore.RED +"]")
			print(Fore.RED +Fore.RED +"                                                   Closing YTZ TokenGen..")
			print(Fore.GREEN +Fore.RED +"                                               JOIN DISCORD https://discord.gg/2CF5GNgnNF FOR HELP!")
			print(Fore.WHITE +Fore.RED +"                         ["+Fore.WHITE +Fore.RED +"+"+Fore.WHITE +Fore.RED +"]"+ Fore.WHITE +Fore.RED +"-------------------------------------------------------"+ Fore.WHITE +Fore.RED +"["+ Fore.WHITE +Fore.RED +"+"+ Fore.WHITE +Fore.RED +"]")
			time.sleep(2)
			sys.exit()
			pass
	...
	with open('Generated.txt', 'r') as f:
	    for line in f:
	        ...
	        try:
	            ...
	            print(f"{Fore.CYAN}Error, please contact with YTZ  via Discord! {Fore.RESET}")
pass
if opcion=='3':
	print(Fore.WHITE +Fore.RED +"                         ["+Fore.WHITE +Fore.RED +"+"+Fore.WHITE +Fore.RED +"]"+ Fore.WHITE +Fore.RED +"-------------------------------------------------------"+ Fore.WHITE +Fore.RED +"["+ Fore.WHITE +Fore.RED +"+"+ Fore.WHITE +Fore.RED +"]")
	print(Fore.WHITE +Fore.RED +"                                         YTZ TokenGen"+Fore.YELLOW+" Made by "+Fore.RED+"YTZ")
	print(Fore.WHITE +Fore.RED +"                                         [Discord] "+Fore.GREEN+"Ytz#4555")
	print(Fore.BLUE +Fore.RED +"                                         [Server] "+Fore.RED+"https://discord.gg/2CF5GNgnNF")
	print(Fore.WHITE +Fore.RED +"                         ["+Fore.WHITE +Fore.RED +"+"+Fore.WHITE +Fore.RED +"]"+ Fore.WHITE +Fore.RED +"-------------------------------------------------------"+ Fore.WHITE +Fore.RED +"["+ Fore.WHITE +Fore.RED +"+"+ Fore.WHITE +Fore.RED +"]")
	input(Fore.RED +Fore.RED +"\nEnter to exit")
	os.system("cls")
	print(Fore.WHITE +Fore.RED +"                         ["+Fore.WHITE +Fore.RED +"+"+Fore.WHITE +Fore.RED +"]"+ Fore.WHITE +Fore.RED +"-------------------------------------------------------"+ Fore.WHITE +Fore.RED +"["+ Fore.WHITE +Fore.RED +"+"+ Fore.WHITE +Fore.RED +"]")
